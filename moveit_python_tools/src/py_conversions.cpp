// From
// https://github.com/ubi-agni/moveit_task_constructor/blob/de9fa8405d481d5b86751d2ef44b1f971ae0d233/core/python/wrapper/src/conversions.cpp
...
{
  return __x.module < __y.module || (!(__y.module < __x.module) && __x.message < __y.message);
}
...
boost::python::object ConverterRegistry::createMessage(const boost::python::type_info& type_info)
{
  ...
  if (cls.is_none())
  {  // load msg module once on demand
